...
latex_documents = [
    (master_doc, 'ladybug geojson.tex', 'ladybug geojson Documentation',
...
man_pages = [
    (master_doc, 'ladybug geojson', 'ladybug geojson Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ladybug geojson', 'ladybug geojson Documentation',
     author, 'ladybug geojson', 'One line description of project.',
     'Miscellaneous'),
]
...
def write_cli_files(ht_cli_data, lib_name, tool_name, doc_folder):
    ...
    Args:
        ...
        lib_name: The name of the library the click groups belong to. For
            example ``honeybee_energy``, ``dragonfly`` or ``ladybug_geojson``
